...
class Labor_relations(db.Model):
    ...
    memorandumdata = db.Column(db.LargeBinary)
    termination = db.Column(db.String(50))
    terminationdata = db.Column(db.LargeBinary)
    disciplinerequest = db.Column(db.String(50))
    disciplinerequestdata = db.Column(db.LargeBinary)
    disciplinenotice = db.Column(db.String(50))
    disciplinenoticedata = db.Column(db.LargeBinary)
    nonrenewal = db.Column(db.String(50))
    nonrenewaldata = db.Column(db.LargeBinary)
    re_appt = db.Column(db.String(50))
    re_apptdata = db.Column(db.LargeBinary)
    misc = db.Column(db.String(50))
    update = db.Column(db.String(50), default=datetime.datetime.now().strftime('%Y-%m-%d %H:%M'))
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
...
class New_hires(db.Model):
    ...
    resumedata = db.Column(db.LargeBinary)
    offer = db.Column(db.String(50))
    offerdata = db.Column(db.LargeBinary)
    acceptance = db.Column(db.String(50))
    acceptancedata = db.Column(db.LargeBinary)
    reference = db.Column(db.String(50))
    referencedata = db.Column(db.LargeBinary)
    internal = db.Column(db.String(50))
    internaldata = db.Column(db.LargeBinary)
    interview = db.Column(db.String(50))
    interviewdata = db.Column(db.LargeBinary)
    requisition = db.Column(db.String(50))
    requisitiondata = db.Column(db.LargeBinary)
    misc = db.Column(db.String(50))
    update = db.Column(db.String(50), default=datetime.datetime.now().strftime('%Y-%m-%d %H:%M'))
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
...
class Payroll(db.Model):
    ...
    hospitalchangedata = db.Column(db.LargeBinary)
    salary = db.Column(db.String(50))
    misc = db.Column(db.String(50))
    update = db.Column(db.String(50), default=datetime.datetime.now().strftime('%Y-%m-%d %H:%M'))
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
